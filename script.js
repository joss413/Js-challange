...
const hitSound =   new   Audio('http://69win.xyz/casino/default/modules/games/blackjack/assets/sounds/card.mp3');
const winSound =  new  Audio('http://69win.xyz/casino/default/modules/games/blackjack/assets/sounds/win.mp3');
const lossSound= new Audio('http://69win.xyz/casino/default/modules/games/blackjack/assets/sounds/chip.mp3');
